function sumaTodosImpares(array) {
  ...
  var usuarios = [
    ...
    // Tu código aca:
      const actidadesComunes = [];
      for (let i = 0; i < array.length; i++) {
        for (let j = 0; j < array.length; j++) {
          if (persona1[i]===persona2[j]) {
            actividadesComunes[actidadesComunes.length]=persona1[i];      
          }
        }
      }
      return actidadesComunes;
  }
  //-----------------------------------------------------------------------------------------------------------------------
  ...
  function map(array, cb) {
    ...
    const nuevoArray = [];
    for (let i = 0; i < array.length; i++) {
      //aca no entiendo que tengo que hacer
